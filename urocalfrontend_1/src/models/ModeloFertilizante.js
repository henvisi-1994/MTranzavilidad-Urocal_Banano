export default class Fertilizante {
    constructor(fertilizacionid, ferciclo, ferfecha, fernombrecomercial, ferelementos, ferconcentracion, ferareaaplicada,
        ...
        this.fernombrecomercial = fernombrecomercial;
        this.ferelementos = ferelementos;
        this.ferconcentracion = ferconcentracion;
        this.ferareaaplicada = ferareaaplicada;
        this.fercantidadaplicada = fercantidadaplicada;
        this.ferunidadmedida = ferunidadmedida;
        this.ferequipoaplicacion = ferequipoaplicacion;
