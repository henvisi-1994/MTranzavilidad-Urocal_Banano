<template>
  <v-dialog v-model="dialogEditarOperarioPersona" scrollable max-width="500px" transition="dialog-transition" :fullscreen="$vuetify.breakpoint.xs ? true : false">
    <v-card tile>
      ...
      <v-card-actions>
        <v-col>
        <!--<v-btn color="error" block @click="dialogEditarOperarioPersona = !dialogEditarOperarioPersona" >Cancelar</v-btn>-->
...
export default {
  ...
  computed: {
    // Según el valor de la variable dialogEditarOperarioPersona muestra u oculta el dialogo
