...
CASE des.desspp WHEN 'True' THEN 'Si' WHEN 'False' THEN 'No' END AS spp, ta.detdesnumerobultos, ta.detdespesounitario, c.centroacopionombre as centroacopio,a.almsaldo
