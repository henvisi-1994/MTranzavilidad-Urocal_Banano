export default class DetalleCompra {
    constructor(detallecompraid, detporcentajefermentacion, detporcentajehumedad, detporcentajeimpurezas, detmoho, detpizarra, detvioleta,
        ...
        this.detporcentajeimpurezas = detporcentajeimpurezas;
        this.detmoho = detmoho;
        this.detpizarra = detpizarra;
        this.detvioleta = detvioleta;
        this.detsemivioleta = detsemivioleta;
        this.detoptimio = detoptimio;
        this.detpenalidad = detpenalidad;
        this.detestimulo = detestimulo;
        this.dettara = dettara;
