<template>
  <v-dialog v-model="dialogEditarReporteEmbarque" scrollable max-width="500px" transition="dialog-transition" :fullscreen="$vuetify.breakpoint.xs ? true : false">
    <v-card tile>
      <v-card-title class="justify-center primary white--text">
        <v-spacer></v-spacer>
        <h5>Editar Reporte de Embarque</h5>
        <v-spacer></v-spacer>
...
export default {
  name: "DialogEditarReporteEmbarque",
