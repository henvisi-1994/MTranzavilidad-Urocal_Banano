<template>
  <v-container fluid>
    ...
    <v-card elevation="0" class="mt-5">
      ...
      <v-row no-gutters justify-md="space-around">
        <v-col  cols="12" sm="6">
          <v-select :items="itemsVariedad"  label="Variedad"  Variedad></v-select>
        </v-col>
      </v-row>

      <v-row no-gutters justify-md="space-around">
        <v-col  cols="12" sm="6">
          <v-select :items="itemsProductor"  label="Productor"  Productor></v-select>
        </v-col>
      </v-row>
...
export default {
  ...
  data() {
    return {
      nombre: "Gestión de Reporte de Compra",
      itemsVariedad: ['Cacao Nacional', 'Ramilla'],
      itemsProductor: ['Productor 1', 'Productor 2', 'Productor 3'],
    };
  },
